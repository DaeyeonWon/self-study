...
| 프레임워크 | 특징 |
|-----------|------|
| **DSPy (Stanford)** | 프롬프트를 선언적으로 정의하고 자동 최적화 |
| **LangChain PromptTemplate** | 템플릿 기반 프롬프트 관리 |
| **LlamaIndex QueryPipeline** | 파이프라인 단위 프롬프트 제어 |
| **Guidance (Microsoft)** | 구조화된 출력 강제 프롬프팅 |
